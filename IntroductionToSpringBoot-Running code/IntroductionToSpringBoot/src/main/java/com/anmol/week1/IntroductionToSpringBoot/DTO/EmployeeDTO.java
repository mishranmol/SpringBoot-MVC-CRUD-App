...
public class EmployeeDTO {
    ...
    //Check the length of string should between 3 and 10 both inclusive
    ...
    //integer = 5 indicates no. of digits before the decimal can be UPTO 5 and fraction = 2 means after the decimal can only UPTO 2
